...
def autocomplete():
    ...
    if request.method == 'GET':  # a query has been submitted
        ...
        if prefix is not None:
            ...
            search_response = opensearch.search(body = queryBody, index=indexName, explain=False)
            print("implemented autocomplete AND instant search")
